    ...
    public static async getAll (ctx: DefaultContext) {
        try {
            ...
            const access_points: any = await AccessPoint.createQueryBuilder('access_point')
                ...
                .leftJoinAndSelect('reader.leaving_zones', 'access_point_zone', 'access_point_zone.delete_date is null')
                .leftJoinAndSelect('reader.came_to_zones', 'access_point_zone', 'access_point_zone.delete_date is null')
