        ...
        Promise.all([acu, access_point, credential]).then((data: any) => {
            ...
            if (acu) {
                ...
                if (credential) {
                    ...
                    eventData.data.cardholder = credential.cardholders ? _.pick(credential.cardholders, ['id', 'email', 'phone', 'avatar', 'first_name', 'last_name', 'family_name', 'company_name', 'status', 'presense', 'vip', 'car_infos', 'antipass_backs', 'limitations', 'access_rights', 'cardholder_groups']) : null
