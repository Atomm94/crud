...
export default class ExtensionDeviceController {
    public static async setExtBrd (location: string, serial_number: number, data: any, session_id: string | null = '0', update?:boolean) {
        new SendDeviceMessage(OperatorType.SET_EXT_BRD, location, serial_number, data, session_id, update)
    }

    public static async delExtBrd (location: string, serial_number: number, data: any, session_id: string | null = '0') {
