...
export default class CtpController {
    public static async setCtp (type: accessPointType, location: string, serial_number: number, data: any, user: number | null = null, session_id: string | null = '0', update?: boolean) {
    ...
    public static async delCtp (type: accessPointType, location: string, serial_number: number, data: any, user: number | null = null, session_id: string | null = '0') {
