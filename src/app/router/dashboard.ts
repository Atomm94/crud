...
export default router
    ...
    .get('Dashboard-getAllAccessPoints', 'dashboard/getAllAccessPoints', Feature.Dashboard.OnlineMonitorDashboard.check, checkRole(), DashboardController.getAllAccessPoints)
