...
export default router
  ...
  .put('Company-ClientCompany-updateItem', 'company/updatePartition', checkRole(), CompanyController.updatePartition)
  ...
  .get('Company-getAllItems', 'company', checkRole(), CompanyController.getAllPartitions)
